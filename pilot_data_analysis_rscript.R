...
#highrank <- c("ed","vc","barr","gen","ceo","tv","super","doc","elect","pilot","head","vet","mp","acc","prop","olymp")
#lowrank <- c("proof","ta","civil","entr","admin","tvcam","shelf","stnur","appelect","driver","clean","barist","bin","wait","retail","bar")
